const MyStartupTitle: React.FC = () => {
  return (
    <div className='flex flex-col justify-center gap-7 bg-[#001f3d] px-[6%] pt-36 pb-64 text-center md:px-80'>
